...
engine = create_engine('postgresql://hcfbotqvrsqlbf:e47f0051e3cc908b937f7e166973d69e6f37ec211ff500349a34cf48a092173a@ec2-52-18-116-67.eu-west-1.compute.amazonaws.com:5432/dffescd43l2npt', future=True)
...
def init_db():
    ...
    import tigrmanagr.models  # need to import all models here to declare table
